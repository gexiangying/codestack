...
sha512_KNOWN = "74e236326a7b7a81883745e3aca20a7f554c4ff57625fd549230bdbf49251609cb3a9e9bb5eaa45efb922534ce8690316c91d8acfa97dfe543e9e457e24ab28a"
...
F = arg[1]
for i, t in ipairs({"sha1", "md5", "sha1", "hmac", "sha512"}) do
  print("testing " .. t)
  local d
  if (t == "hmac") then
